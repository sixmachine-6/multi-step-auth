...
function error(error, type) {
  hideError();
  var markup = "<div class=\"error ".concat(type, "\">").concat(error, "</div>");
  document.querySelector("body").insertAdjacentHTML("afterbegin", markup);
}
},{}],"otp.js":[function(require,module,exports) {
"use strict";
...
var checkOtp = exports.checkOtp = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.status === 200) {
            (0, _error.error)("logged in successfully", "correct");
        ...
        case 8:
          ...
          (0, _error.error)(_context.t0.response.data.message, "wrong");
        case 12:
        case "end":
  ...
  return function checkOtp(_x) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../node_modules/axios/index.js","./error":"error.js"}],"signup.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, confirmPassword) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          (0, _error.error)("please wait!!! sending the otp to email...This might take few seconds Be Patient!!!", "correct");
          _context.next = 4;
          return (0, _axios.default)({
            method: "POST",
...
},{"axios":"../node_modules/axios/index.js","./error":"error.js"}],"login.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js","./error":"error.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _otp = require("./otp");
var _signup = require("./signup");
var _login = require("./login");
var formContainer = document.querySelector(".form--signup");
...
},{"./otp":"otp.js","./signup":"signup.js","./login":"login.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
